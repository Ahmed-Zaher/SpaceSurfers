...
class gameIntro:
    ...
    def run():
        while True:
            ...
            gameIntro.messageToScreen("Space Surfers", lightBlack, -270, size="reallylarge")
            gameIntro.button("Play", 465, 190, 350, 80, purple, lightBlack, "play")
            gameIntro.button("Controls", 465, 310, 350, 80, purple, lightBlack, "controls")
            gameIntro.button("Credits", 465, 430, 350, 80, purple, lightBlack, "credits")
            gameIntro.button("Quit", 465, 550, 350, 80, purple, lightBlack, "quit")
    ...
    def init():
        ...
        gameIntro.reallyLargeFont = pygame.font.SysFont("Ubuntu Medium", 110)
    ...
    def textObjects(text, color, size="small"):
        if size == "small":
            ...
            textSurface = gameIntro.reallyLargeFont.render(text, True, color)
